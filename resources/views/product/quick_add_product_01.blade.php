<div class="modal-dialog modal-lg" style="z-index: 1051 !important;max-height: 600px;overflow: auto;" role="document">
    <h1>Hellpw</h1>
  <div class="modal-content">
    {!! Form::open(['url' => action([\App\Http\Controllers\ProductController::class, 'saveQuickProduct']), 'method' => 'post', 'id' => 'quick_add_product_form_01' ]) !!}
...
<script type="text/javascript">
  $(document).ready(function(){
    $("form#quick_add_product_form_01").validate({
      rules: {
          sku: {
              remote: {
      ...
      submitHandler: function (form) {
        ...
        var form = $("form#quick_add_product_form_01");
        ...
        $.ajax({
            ...
            success: function(data){
                $('.quick_add_product_modal_01').modal('hide');
