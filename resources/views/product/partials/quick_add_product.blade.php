<div class="modal-dialog modal-lg" style="z-index: 1051 !important;" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body" style="overflow: auto; z-index:10001;">
      ...
      <div class="row">
        <div class="form-group col-sm-11 col-sm-offset-1">
          @include('product.partials.single_product_form_part', ['profit_percent' => $default_profit_percent, 'price' => $price, 'quick_add' => true ])
        </div>
      </div>
      ...
      submitHandler: function (form) {
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                $("#import_purchase_invoice_modal").show();

                
                $("#import_purchase_invoice_modal").trigger('modal_opened');
