...
// use Google\Cloud\DocumentAI\V1beta3\DocumentUnderstandingServiceClient;
// use Google\Cloud\DocumentAI\V1beta3\ProcessDocumentRequest;
...
class PurchaseController extends Controller
{
    ...
    /**
     * set product name and qty to session...
     */
    public function saveValueToSession(Request $request) {
        try {
            Session::put('product_name', $request->input('product_name'));
            Session::put('qty', $request->input('qty'));
    ...
    /**
     * get product name and qty to session to replace a row....
     */
